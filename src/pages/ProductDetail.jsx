      ...
      <div>
        ...
        <div className="my-5">
          <span className="w-fit px-5 py-2 flex items-center justify-center rounded-full gap-10 border border-green-500 text-green-500">
            ...
            <span className="text-green-900 font-bold text-md">{quantity}</span>
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <Button
              ...
              onClick={handleAdd}
              className="w-full bg-white text-green-500! border-green-500! hover:bg-green-500! hover:text-white!"
            >
